...
export default function VerifyEmail() {
  ...
  const SuccessMessage = () => (
    <div className="success-message">
      ...
      <p>
        Your email has been verified and your account is now active. You will be
        redirected to the login page shortly.
      </p>
      <Link to={ROUTES.ADMIN.LOGIN}>Login Now</Link>
    </div>
  );
  ...
  const InvalidTokenMessage = () => (
    <div className="error-message">
      ...
      <div className="action-links">
        <Link to={ROUTES.AUTH.RESEND_VERIFICATION}>
  ...
  const AdditionalLinks = () => (
    <div className="auth-links">
      <div style={{ fontSize: "0.9rem", color: "var(--txt-clr)" }}>
        Already verified? <Link to={ROUTES.ADMIN.LOGIN}>Sign In</Link>
      </div>
      <div style={{ fontSize: "0.9rem", color: "var(--txt-clr)" }}>
