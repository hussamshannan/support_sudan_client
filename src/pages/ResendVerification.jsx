...
export default function ResendVerification() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await post("/auth/resend-verification", formData);
  ...
  const SuccessMessage = () => (
    <div className="success-message">
      ...
      <p>
        We've sent a new verification link to <strong>{formData.email}</strong>.
        Please check your email and click the link to verify your account.
      </p>
      <div className="success-actions">
        <Link to={ROUTES.ADMIN.LOGIN} className="success-link">
          Back to Login
        </Link>
      </div>
    </div>
  ...
  const AdditionalLinks = () => (
    <div className="auth-links">
      <Link to={ROUTES.ADMIN.LOGIN}>Back to Login</Link>
    </div>
  );
